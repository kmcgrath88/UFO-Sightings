...
tableData.forEach((ufo) => {
    ...
    // Use object entries to loop through data and table, and console.log each ufo value.
...
// Using multiple input tags, write JavaScript code so the user can set multiple filters 
// and search for UFO sightings using the following criteria based on the 
...
function filter_Data(){
    ...
    // Using object entries to loop through input keys, console.log each ufo filtered value, and
    // setting input value to all lowercase.
